...
const player = document.querySelector('#player'); //é o <h2 id="player">Vez do jogador X</h2>
let turno = true;
...
function verificarGanhador(jogador){
  //percorrer todas as possiveis combinacoes ganhadoras e compara se a combinação atual se encaixa em uma combinação ganhadora
